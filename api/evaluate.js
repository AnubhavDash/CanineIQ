...
const BREED_RESEARCH = { french_bulldog: 'BOAS, heat intolerance, spinal disease, skin and eye concerns; use health-tested, functional lines.', pug: 'BOAS, eye injury, skin-fold disease, obesity and spinal concerns; noisy breathing is not automatically normal.', english_bulldog: 'Airway, orthopedic, skin, reproductive and heat concerns; extreme conformation can impair ordinary function.', dachshund: 'Intervertebral disc disease risk associated with long-backed, short-legged structure; weight and jumping management matter.', german_shepherd: 'Hip and elbow disease, degenerative myelopathy and temperament variation; documented testing and sound movement matter.', cavalier: 'Early mitral valve disease and neurologic concerns including Chiari-like malformation and syringomyelia.', great_dane: 'Gastric dilatation-volvulus, cardiomyopathy, orthopedic stress and short lifespan associated with giant size.', boxer: 'Cardiac disease, cancer risk and heat/exercise considerations; family longevity and screening matter.' };\n\nconst BREED_CONTEXT = {
...
export default async function handler(req, res) {
  ...
  try {
    ...
    return res.status(502).json({ error: 'Evaluation unavailable. Please try again.' });
  }
}
